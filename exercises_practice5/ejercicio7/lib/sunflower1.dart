...
import 'package:ejercicio7/rotatingwidget.dart';
import 'package:flutter/material.dart';

const int maxSeeds = 500;

class SunflowerPage1 extends StatefulWidget {
  const SunflowerPage1({super.key});
...
class _SunflowerState extends State<SunflowerPage1> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(title: const Text('Sunflower 1')),
        body: Center(
          child: Column(
  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
      decoration: BoxDecoration(
        color: lit ? Colors.pinkAccent : Colors.grey.shade700,
