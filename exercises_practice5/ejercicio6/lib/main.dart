...
//
//  - ¿Como se llama el widget responsable de la animación? -
//  RE: SunflowerWidget, el cual hace uso de un array del Widget Dot
//  
//  - ¿Qué parámetros tiene? -
//  RE: El Widget SunflowerWidget contiene los siguientes parámetros:
//      - tau:          Valor que permite distribuir los Widget Dot equitativamente
//      - scaleFactor:  Espacio entre cada Widget Dot
//      - size:         Escala del Sunflower al completo    
//      - phi:          Representa la Proporción Aúrea
//      - rng:          Generador de Números Aleatorio
//
//  - ¿Como puedes acelerar/ralentizar la animación? -
//  RE: Cambiando el valor de duración del widget AnimatedAlign
//
//  - ¿Como puedes modificar la curva? -
//  RE: Cambiando el valor de curva del widget AnimatedAlign
